          ...
          <>
            {borrower.map((n, m) => {
              ...
              return (
                <>
                  {n.id === j.docConfigId &&
                    console.log("here you need to print")}
                </>
              );
            })}
          </>
            ...
            <Collapse in={expanded3} timeout='auto' unmountOnExit>
              <CardContent>
                ...
                <Grid container item xs={12} style={{ marginTop: "2rem" }}>
                  ...
                  >
                    {property.keyCaptionOne == null
                      ? ""
                      : property.keyCaptionOne}
                    {property.keyCaptionOneRequired ? "*" : ""}
                  </Grid>
                  <Grid item xs={4}>
                    {/* keyCaptionOne */}
                    {/* {vjob.documments.id == null ? "" : vjob.bankId} */}
                    ...
                    {vjobq.documents.map((j, k) => {
                      ...
                      return (
                        <>
                          {borrower.map((n, m) => {
                            console.log("foooo", n);
                            console.log("foooo", n.id);
                            return (
                              <>
                                {n.id === j.docConfigId &&
                                // console.log("here you need to print")
                                n.keyCaptionThree == null
                                  ? ""
                                  : n.keyCaptionThree}
                              </>
                            );
