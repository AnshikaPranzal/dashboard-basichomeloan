        ...
        >
          ...
          >
            <div style={{ fontWeight: 600, fontFamily: "Open Sans" }}>
              ...
              <div>
                {vjobs.map((obj2, i) => {
                  return <div>{obj2.id === vjob.id && obj2.customerName}</div>;
                })}
              </div>
            </div>
            <div
            ...
            >
              ...
              <div>
                {vjobs.map((obj2, i) => {
                  return (
                    <div>{obj2.id === vjob.id && obj2.applicationStage}</div>
                  );
                })}
              </div>
            </div>
  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Accordion className={classes.text} style={{ marginTop: "2rem" }}>
          <AccordionSummary
          ...
          <AccordionDetails>
            <div>
              ...
              <Grid container item xs={12}>
                ...
                <div
                  style={{ fontWeight: 600, fontSize: 15, marginTop: "1rem" }}
                >
                  Documents:
                </div>
                <Grid conatiner item xs={12}>
                  <Grid item xs={6}>
                    {/* {vjob.documents.map((o, i) => {
                      return <p>{o.fileOneUrl == null ? "" : o.fileOneUrl}</p>;
                    })} */}
                  </Grid>
                </Grid>
              </Grid>
        ...
        <Accordion className={classes.text} style={{ marginTop: "2rem" }}>
          ...
          <AccordionDetails>
            <div>
              <div style={{ fontWeight: 600 }}>Primary Borrower</div>
              <Grid container item xs={12}>
                <Grid item xs={8}>
                  Name
                </Grid>
