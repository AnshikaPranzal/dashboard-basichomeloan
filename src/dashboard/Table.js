                          ...
                          <Paper>
                            <ClickAwayListener onClickAway={handleClose}>
                              <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown}>
                                <MenuItem onClick={(e)=>{filter('');handleClose(e)}}>All</MenuItem>
                                <MenuItem onClick={(e)=>{filter('Lead');handleClose(e)}}>Lead</MenuItem>
                                <MenuItem onClick={(e)=>{filter('PendingOSV');handleClose(e)}}>PendingOSV</MenuItem>
                                <MenuItem onClick={(e)=>{filter('Disbursed');handleClose(e)}}>Disbursed</MenuItem>
                                <MenuItem onClick={(e)=>{filter('SentForBasicFulfillment');handleClose(e)}}>SentForBasicFulfillment</MenuItem>
                              </MenuList>
                            </ClickAwayListener>
                          </Paper>
                        </Grow>
